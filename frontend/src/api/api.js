...
// License申请列表
export const licenseApplication= params => ajaxGet({url: `license/application/`,params})
// License申请 新增
export const licenseApplicationAdd= params => ajaxPost({url: `license/application/`,params})
// License申请 编辑
export const licenseApplicationEdit= params => ajaxPut({url: `license/application/`,params})
// License申请 删除
export const licenseApplicationDelete= params => ajaxDelete({url: `license/application/`,params})
// License申请 详情
export const licenseApplicationDetail= params => ajaxGetDetailByID({url: `license/application/`,params})
// License申请 制作License
export const licenseApplicationGenerate= (id) => ajaxPost({url: `license/application/${id}/parse_and_generate/`,params: {}})
// License申请 重试
export const licenseApplicationRetry= (id) => ajaxPost({url: `license/application/${id}/retry/`,params: {}})

// License记录列表
export const licenseRecord= params => ajaxGet({url: `license/record/`,params})
// License记录 详情
export const licenseRecordDetail= (id) => ajaxGet({url: `license/record/${id}/`,params: {}})
// License记录 删除
export const licenseRecordDelete= params => ajaxDelete({url: `license/record/`,params})
// License记录 统计信息
...
// License字段映射 新增
export const licenseFieldMappingAdd= params => ajaxPost({url: `license/field-mapping/`,params})
// License字段映射 编辑
export const licenseFieldMappingEdit= params => ajaxPut({url: `license/field-mapping/`,params})
// License字段映射 删除
export const licenseFieldMappingDelete= params => ajaxDelete({url: `license/field-mapping/`,params})
...
// 流程类型列表
export const workflowType= params => ajaxGet({url: `workflow/workflow-type/`,params})
// 流程类型 新增
export const workflowTypeAdd= params => ajaxPost({url: `workflow/workflow-type/`,params})
// 流程类型 编辑
...
// 流程步骤 新增
export const workflowStepAdd= params => ajaxPost({url: `workflow/workflow-step/`,params})
// 流程步骤 编辑
export const workflowStepUpdate= params => ajaxPut({url: `workflow/workflow-step/`,params})
// 流程步骤 删除
export const workflowStepDelete= params => ajaxDelete({url: `workflow/workflow-step/`,params})
// 流程步骤 批量更新
...
// 抄送配置 新增
export const workflowCCAdd= params => ajaxPost({url: `workflow/workflow-cc/`,params})
// 抄送配置 编辑
export const workflowCCUpdate= params => ajaxPut({url: `workflow/workflow-cc/`,params})
// 抄送配置 删除
export const workflowCCDelete= params => ajaxDelete({url: `workflow/workflow-cc/`,params})
