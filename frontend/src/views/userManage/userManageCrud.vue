...
<script lang="jsx">
    import {UsersUsers,UsersUsersAdd,UsersUsersDelete,UsersUsersEdit,UsersUsersdisableEdit,UsersUsersExportexecl,apiSystemDept,apiSystemRole} from '@/api/api'
                ...
                crudConfig:{
                    ...
                    tableColumns:[
                        ...
                        {label:'密码',prop:'password',type:'input',minWidth:'110',sortable: false,hidden:true,
                         ...
                         {label:'所属部门',prop:'dept',type:'select',minWidth:'120',sortable: false,hidden:false,
                            form:{
                                //表单属性
                                span:12,
                                placeholder: '请选择部门',
                         ...
                         {label:'角色',prop:'role',type:'select',minWidth:'120',sortable: false,hidden:false,
                            form:{
                                //表单属性
                                span:12,
                                placeholder: '请选择角色',
                         ...
                         {label:'允许登录后台',prop:'is_staff',type:'radio',minWidth:'120',sortable: false,hidden:false,
                             render: (row) =>{
                             ...
                             form:{
                                 //表单属性
                                 span:12,
                                 options:templateData.STATUS_BOOL,
                                 defaultValue:false,//新增时默认为否
                             }
                         },
